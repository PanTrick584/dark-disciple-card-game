...
const skillExecutionStrategies = {
    [SKILL_EXECUTION.PLAY]: (skill, card, players, currentPlayerId, opponentId) => {
        // Generic play skill execution
        const updatedCard = updateCard(skill, card);

        // Target selection logic
        const targets = selectTargets(skill.targetType, players, currentPlayerId, opponentId);
    ...
    [SKILL_EXECUTION.PREPARATION]: (skill, card, players, currentPlayerId, opponentId) => {
    ...
    [SKILL_EXECUTION.CYCLE]: (skill, card, players, currentPlayerId, opponentId) => {
        // Cycle skill logic
        const updatedCard = updateCard(skill, card);
