...
import { FilterLevels } from '../FilterLevels/FilterLevels';
...
export const CardsViewer = ({ dataLocation, name }) => {
    ...
    return (
        ...
        <div className="cards">
            <div className="cards-filter">
                {/* CARDS LEVELS */}
                {factionData && name && <nav className='cards-filter-levels'>
                    <FilterLevels
                ...
                {/* CATEGORIES */}
                {factionData && name && <nav className="cards-filter-categories">
                    <FilterCategories
